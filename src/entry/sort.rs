...
fn compare_sub_entries(
    entry_1: &Box<dyn Entry>,
    entry_2: &Box<dyn Entry>,
) -> Ordering {
...
pub fn sort_sub_entries(entries: &mut Vec<Box<dyn Entry>>) {
    entries.sort_by(compare_sub_entries);
}
